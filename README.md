...
📌 Problem Statement
  ...
  Mercedes-Benz aims to reduce the time cars spend on the test bench during manufacturing.The objective of this project is to build a Machine Learning model that can accurately predict testing time (y) based on various anonymized features.
